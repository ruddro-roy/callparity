...
Revision ID: f0418d18d0f7
Revises:
Create Date: 2026-08-28 12:20:26.550054
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_transcript_pointers_ticket_id"), "transcript_pointers", ["ticket_id"], unique=False
    )
